...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params[f'W1'] = weight_scale * np.random.randn(num_filters, C, filter_size, filter_size)
        self.params[f'b1'] = np.zeros(num_filters)
        self.params[f'W2'] = weight_scale * np.random.randn(num_filters * (H // 2) * (W // 2), hidden_dim)
        self.params[f'b2'] = np.zeros(hidden_dim)
        self.params[f'W3'] = weight_scale * np.random.randn(hidden_dim, num_classes)
    ...
    def loss(self, X, y=None):
        ...
        scores, aff_cache = affine_forward(ar_out, W3, b3)
        ...
        dx, dw, db = affine_backward(dscores, aff_cache)
